...
class OrganizationTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organization_type" do
    assert_difference('OrganizationType.count') do
      post organization_types_url, params: { organization_type: { description: @organization_type.description, name: @organization_type.name, status: @organization_type.status, user_id: @organization_type.user_id } }
    end
  ...
  test "should update organization_type" do
    patch organization_type_url(@organization_type), params: { organization_type: { description: @organization_type.description, name: @organization_type.name, status: @organization_type.status, user_id: @organization_type.user_id } }
